...
echo "<h2>" . __( 'Add Media from URL', 'lh-add-media-from-url-identifier' ) . "</h2>";
...
<form method="post">
URL: <input type="url" name="lh_add_media_from_url-file_url" id="lh_add_media_from_url-file_url" value="<?php echo $value; ?>" size="50" />
